...
LOCAL_SRC_FILES := $(SOURCES) ../libretro/libretro.cpp $(SRCDIR)/utils/ConvertUTF.c ../libretro/performance.c
GLOBAL_DEFINES := -D__RETRO_ARM__ $(JIT) -DHAVE_LIBZ -fexceptions

LOCAL_CXXFLAGS += -O3 -DLSB_FIRST -D__LIBRETRO__ -Wno-write-strings -DANDROID -DFRONTEND_SUPPORTS_RGB565 $(CYCLONE_DEFINES) $(GLOBAL_DEFINES)
LOCAL_CFLAGS = -O3 -DLSB_FIRST -D__LIBRETRO__ -Wno-write-strings -DANDROID -DFRONTEND_SUPPORTS_RGB565 $(GLOBAL_DEFINES)

LOCAL_C_INCLUDES = -I../libretro/zlib -iquote ../src -iquote ../libretro
